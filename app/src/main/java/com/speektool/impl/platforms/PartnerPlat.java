        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_LOGIN_CALLBACK.equals(intent.getAction())) {
                ...
                if (TextUtils.isEmpty(token)) {
                    T.showShort(mContext, "validate fail,token is null.");
                    return;
                }
...
//				UniversalHttp.downloadFile(zipurlfileReal, "", tempzip);
    ...
    private void downloadAndUploadVideo(final String videoFileUrl) {
        ...
        File saveFile =
//                UniversalHttp.downloadFile(videoFileUrlReal, "", tempMp4);
        null;
        if (saveFile != null) {// download success.
            ...
            if (!TextUtils.isEmpty(thumbUrl)) {
                ...
                File thumb =
//                        UniversalHttp.downloadFile(thumbFileUrlReal, "", tempThumb);
                null;
                if (thumb != null) {
