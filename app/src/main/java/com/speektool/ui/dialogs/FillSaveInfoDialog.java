...
public class FillSaveInfoDialog extends Dialog implements OnClickListener, RecordTypeLoadListener, OnDismissListener,
    ...
    private static final int SWIPE_MENU_ITEM_WIDTH = DensityUtils.dp2px(SpeekToolApp.app(), 90);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secondPage.getListView().setOnMenuItemClickListener(new OnMenuItemClickListener() {
            @Override
