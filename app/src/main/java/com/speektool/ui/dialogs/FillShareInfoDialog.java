 ...
 * 
 */
public class FillShareInfoDialog extends Dialog implements View.OnClickListener, PlatformActionListener {
	...
	private void doshare() {
		...
		case SINA_WEIBO: {
			...
			mSWBparams.text = etShareContent.getText().toString();
			...
			SinaWeibo mSinaWeibo = (SinaWeibo) ShareSDK.getPlatform(getContext(), SinaWeibo.NAME);
			mSinaWeibo.setPlatformActionListener(this);
			mSinaWeibo.SSOSetting(true);
			mSinaWeibo.share(mSWBparams);
		}
			break;
		case TENCENT_WEIBO: {
			if (mShareState != null)
			...
			TencentWeibo tencentWeibo = (TencentWeibo) ShareSDK.getPlatform(getContext(), TencentWeibo.NAME);

			tencentWeibo.setPlatformActionListener(this);
			tencentWeibo.SSOSetting(true);
			tencentWeibo.share(mSWBparams);
		}
			break;
		default:
			break;
