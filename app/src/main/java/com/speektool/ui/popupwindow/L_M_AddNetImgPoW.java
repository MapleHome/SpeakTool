...
import com.speektool.adapters.AdapterNetPictures;
...
import com.speektool.tasks.TaskLoadPictureSearchCategory;
import com.speektool.tasks.TaskSearchNetPictures;
import com.speektool.tasks.TaskSearchNetPictures.SearchNetPicturesCallback;
			...
			public void run() {
				if (BitmapScaleUtil.isGif(bean.picUrl)) {// gif.
					...
					if (cache != null) {// cache.
						...
						try {
							byte[] buf = UniversalHttp.downloadFile(bean.picUrl, "http://img4.duitang.com");// gif.
							if (buf != null) {
