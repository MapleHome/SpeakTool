...
public class StrokeWidthPreview extends View {
	...
	private void init() {
		...
		// init path.
		mPath = new Path();
		int previewWidth = getContext().getResources().getDimensionPixelSize(R.dimen.popup_selectColor_width);
		int previewHeight = getContext().getResources().getDimensionPixelSize(
				R.dimen.popup_selectColor_strokepreview_height);
