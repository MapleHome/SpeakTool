...
import com.speaktool.ui.adapters.AdapterThirdpartyList;
...
public class ThirdpartyListDialog extends Dialog implements View.OnClickListener, OnDismissListener {
    ...
    private static final int THIRD_PARTYLIST_DIALOG__WIDTH = DensityUtils.dp2px(SpeakToolApp.app(), 300);// pix
    private static final int THIRD_PARTYLIST_DIALOG_HEIGHT = DensityUtils.dp2px(SpeakToolApp.app(), 350);// pixv
