...
public class OneButtonAlertDialog extends Dialog implements View.OnClickListener {
	...
	private static final int DIALOG__WIDTH = DensityUtils.dp2px(SpeakToolApp.app(), 400);// pix
	private static final int DIALOG_HEIGHT = DensityUtils.dp2px(SpeakToolApp.app(), 250);// pixv
