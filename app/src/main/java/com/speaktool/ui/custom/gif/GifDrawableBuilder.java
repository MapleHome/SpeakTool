package com.speaktool.ui.custom.gif;
...
/**
 * Builder for {@link GifDrawable} which can be used to
 * construct new drawables by reusing old ones.
 */
public class GifDrawableBuilder {
	...
	/**
	 * Appropriate constructor wrapper. Must be preceded by on of {@code from()}
	 * calls.
	 * 
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(InputStream)}
	 * 
	 * @param inputStream
	 *            data source
	 * @return this builder instance, to chain calls
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(AssetFileDescriptor)}
	 * 
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(AssetManager, String)}
	 * 
	 * @param assetManager
	 *            assets source
	 * @param assetName
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(ContentResolver, Uri)}
	 * 
	 * @param uri
	 *            data source
	 * @param contentResolver
	 *            resolver used to query {@code uri}
	 * @return this builder instance, to chain calls
	 */
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(File)}
	 * 
	 * @param file
	 *            data source
	 * @return this builder instance, to chain calls
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(String)}
	 * 
	 * @param filePath
	 *            data source
	 * @return this builder instance, to chain calls
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(ByteBuffer)}
	 * 
	 * @param byteBuffer
	 *            data source
	 * @return this builder instance, to chain calls
	...
	/**
	 * Wrapper of
	 * {@link GifDrawable#GifDrawable(Resources, int)}
	 * 
	 * @param resources
	...
	private static class ByteBufferSource implements Source {
		...
		public GifDrawable build(GifDrawable oldDrawable) throws IOException {
			return new GifDrawable(GifInfoHandle.openDirectByteBuffer(byteBuffer, false), byteBuffer.capacity(),
					oldDrawable);
		}
	}
