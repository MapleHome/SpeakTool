...
public class GifAnimationMetaData implements Serializable, Parcelable {
	...
	/**
	 * 从输入流中检索Meta Data.输入流 必须支持标记,将抛出非法参数异常 .
	 * 
	 * @param stream
	 *            stream to read from
	 * @throws IOException
	...
	/**
	 * Retrieves metadata from {@link Uri} which is resolved using
	 * {@code resolver}.
	...
	public String toString() {
		...
		String suffix = String.format(Locale.US, "GIF: size: %dx%d, frames: %d, loops: %s, duration: %d", mWidth,
				mHeight, mImageCount, loopCount, mDuration);
